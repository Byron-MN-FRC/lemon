...
public class OI {
    ...
    public JoystickButton btn4BallControllerUp;
    public JoystickButton btn5BallControllerDown;
    ...
    public OI() {
        ...
        btn5BallControllerDown = new JoystickButton(joystick, 5);
        btn5BallControllerDown.whenPressed(new BallControllerDown());
        btn4BallControllerUp = new JoystickButton(joystick, 4);
        btn4BallControllerUp.whenPressed(new BallControllerUp());
        ...
        SmartDashboard.putData("BallControllerUp", new BallControllerUp());
        SmartDashboard.putData("BallControllerDown", new BallControllerDown());
